...
contract {{CONTRACT_NAME}} is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = {{TOKEN_SUPPLY}} * 10**_decimals;
    string private _name = unicode"{{TOKEN_NAME}}";
    string private _symbol = unicode"{{TOKEN_SYMBOL}}";
    uint256 public _maxTxAmount = {{MAX_TX_AMOUNT}} * 10**_decimals;
    uint256 public _maxWalletSize = {{MAX_WALLET_SIZE}} * 10**_decimals;
    uint256 public _taxSwapThreshold= {{TAX_SWAP_THRESHOLD}} * 10**_decimals;
    uint256 public _maxTaxSwap= {{MAX_TX_SWAP}} * 10**_decimals;
